 ...
 */
public class SourceDest extends AppCompatActivity implements AdapterView.OnItemSelectedListener,View.OnClickListener {
    Button jschedule;
    Spinner jsrc,jdst;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sourcdest);
        getSupportActionBar();
        jschedule=(Button)findViewById(R.id.schedule);
        jschedule.setOnClickListener(this);
        jsrc=(Spinner)findViewById(R.id.spinsrc);
        jdst=(Spinner)findViewById(R.id.spindst);
    ...
    public void onClick(View v) {
        ...
        if(sk==dk) Toast.makeText(this,"Source and Destination must be different", Toast.LENGTH_LONG).show();
        else {
            switch(sk){
                case 0: srmanip=Guduvancherry; break;
                case 1: srmanip=Vandalur; break;
                case 2: srmanip=Tambaram; break;
                case 3: srmanip=Vadapalani; break;
                case 4: srmanip=Ambattur; break;
                case 5: srmanip=Avadi; break;
                case 6: srmanip=Perambur; break;
                case 7: srmanip=Egmore; break;
                case 8: srmanip=Madhavaram; break;
                case 9: srmanip=Adyar; break;
                case 10: srmanip=Porur; break;
                case 11: srmanip=Anna_Nagar; break;
                case 12: srmanip=Koyambedu; break;
                case 13: srmanip=Mangadu; break;
                case 14: srmanip=Thiruvotriyur; break;
                case 15: srmanip=Thiruverkadu; break;
                default:srmanip=Guduvancherry; break;

            }
            switch(dk){
                case 0: dsmanip=Guduvancherry; break;
                case 1: dsmanip=Vandalur; break;
                case 2: dsmanip=Tambaram; break;
                case 3: dsmanip=Vadapalani; break;
                case 4: dsmanip=Ambattur; break;
                case 5:dsmanip=Avadi; break;
                case 6: dsmanip=Perambur; break;
                case 7: dsmanip=Egmore; break;
                case 8: dsmanip=Madhavaram; break;
                case 9: dsmanip=Adyar; break;
                case 10: dsmanip=Porur; break;
                case 11: dsmanip=Anna_Nagar; break;
                case 12: dsmanip=Koyambedu; break;
                case 13: dsmanip=Mangadu; break;
                case 14: dsmanip=Thiruvotriyur; break;
                case 15: dsmanip=Thiruverkadu; break;
                default:dsmanip=Tambaram; break;
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(spinner.getId() == R.id.spinsrc)
        {
          // srk = parent.getItemAtPosition(position).toString();
           // Toast.makeText(this,item,Toast.LENGTH_LONG).show();
            sk=position;
        }
        else if(spinner.getId() == R.id.spindst)
        {
